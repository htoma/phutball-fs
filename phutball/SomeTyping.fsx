...
type BoardForm() = 
    ...
    let drawButton (form:Form) (x,y) caption (sizeX, sizeY) = 
    ...
    let drawBoard (form:Form) = 
        ...
        drawButton form (offsetX, buttonY) "Ball" (buttonWidth, buttonHeight)   
        drawButton form (offsetX+buttonSpacing+buttonWidth, buttonY) "Player" (buttonWidth, buttonHeight)
        drawButton form (offsetX, buttonY+buttonSpacing+buttonHeight) "OK" (buttonWidth, buttonHeight)
    ...
    let initializeForm() =         
        ...
        form.Paint.Add(fun e -> drawBoard form)
